...
class SslCommerzPaymentController extends Controller
{
    ...
    public $customer_phone = "0";
    public $customer_country = "0";
    ...
    public function index(Request $request)
    {
        ...
        $this->customer_country = $request->customer_country; 
        $this->customer_city = $request->customer_city; 
        $this->customer_address = $request->customer_address; 
        $this->customer_postcode = $request->customer_postcode; 
        $this->customer_message = $request->customer_message; 
        $this->payment_option = $request->payment_option;

        $order_id = Cartorder::insertGetId([
        ...
        $post_data = array();
        $post_data['total_amount'] = session('session_total_amount'); # You cant not pay less than 10
    ...
    public function success(Request $request)
    {
        ...
        if($success_status == 1){
            Notify::success('Payment Successfully Complated', 'Success');
